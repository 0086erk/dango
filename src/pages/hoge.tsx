      ...
      <div className="m-10 p-4 w-2/3 mx-auto shadow-lg border-2 rounded-2xl">
        <div className="mx-auto">
          ...
          <div className=" grid grid-cols-4 gap-2">
            ...
            <Button
              className="py-2 bg-pink-200 text-white rounded border border-gray-200 cursor-pointer"
              onClick={() => {
                console.log(count);
            ...
            <Button
              className="py-2 bg-gray-300 text-white rounded border border-gray-200 cursor-pointer"
              onClick={() => {
                console.log(count);
